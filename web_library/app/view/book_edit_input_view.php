<?php
          require '../controller/book_edit_controller.php';
          require '../common/define.php'; 
					// Check nếu sách không tồn tại ID thì router back về màn list
          // if($_GET['id']===NULL){
          //   header("Location: ../view/book_search_view.php");
          // }
?>
<!DOCTYPE html>
<html lang="en">
...
<button class="custombackhome"><a href="../../index.php"><img src="https://img.icons8.com/material-outlined/24/FFFFFF/home--v2.png"/>Trang chủ</a></button>
    ...
    <div class="col-md-12">  
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-sm-7">
                    <select name="category" id="category" class="building-input">
                        <?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-sm-7">
                    <select name="author" id="author" class="building-input">
                        <?php 
