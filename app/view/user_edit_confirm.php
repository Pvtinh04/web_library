<?php if(!isset($_GET['page'])) header('location:../../index.php?page=user_edit_confirm'); ?>
...
<label style="margin-left: 20px;  width: 320px; display: flex; align-items: center; font-size: 16px">
            ...
            if (!empty($_SESSION['user_avatar'])){
                ...
                <img style ="display: block;height:150px " src="<?php echo $_SESSION['user_avatar']; ?>" alt="">
            <?php
            }
            ?>
            </label>   
